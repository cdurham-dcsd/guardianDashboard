...
export const SELECTED_VALUE = `${ECHECKIN_SERVICE}/selected_value/index.json`; // can be GET with ?studentNumber=<studentInfo>&optionType=<optionType> or (can be POST with a dto)
