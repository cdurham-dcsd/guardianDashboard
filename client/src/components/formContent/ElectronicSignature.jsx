            ...
            <div className="input-container">
                <div className="e-sig-input">
                        <div>
                            ...
                            <Fade bottom>
                                <label className="hidden-label" htmlFor="firstName">First Name</label>
                            </Fade>)}
                        </div>
                ...
                <div className="e-sig-input">
                    <div>
                        ...
                        <Fade bottom>
                            <label className="hidden-label" htmlFor="middleName">Middle Name</label>
                        </Fade>)}
                    </div>
                ...
                <div className="e-sig-input">
                    <div>
                        ...
                        <Fade bottom>
                            <label className="hidden-label" htmlFor="lastName">Last Name</label>
                        </Fade>)}
                    </div>
